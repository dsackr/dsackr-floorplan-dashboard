 ...
 */
const P = window, V = P.ShadowRoot && (P.ShadyCSS === void 0 || P.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, W = Symbol(), q = /* @__PURE__ */ new WeakMap();
let it = class {
  constructor(t, e, s) {
...
const dt = (n) => new it(typeof n == "string" ? n : n + "", void 0, W), Ct = (n, ...t) => {
 ...
 */
var R;
const N = window, J = N.trustedTypes, ut = J ? J.emptyScript : "", K = N.reactiveElementPolyfillSupport, z = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? ut : null;
      break;
  ...
  return e;
} }, nt = (n, t) => t !== n && (t == t || n == n), M = { attribute: !0, type: String, converter: z, reflect: !1, hasChanged: nt }, D = "finalized";
let g = class extends HTMLElement {
  ...
  _$EO(t, e, s = M) {
    ...
    if (o !== void 0 && s.reflect === !0) {
      const r = (((i = s.converter) === null || i === void 0 ? void 0 : i.toAttribute) !== void 0 ? s.converter : z).toAttribute(e, s.type);
  ...
  _$AK(t, e) {
    ...
    if (o !== void 0 && this._$El !== o) {
      const r = i.getPropertyOptions(o), a = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((s = r.converter) === null || s === void 0 ? void 0 : s.fromAttribute) !== void 0 ? r.converter : z;
      this._$El = o, this[o] = a.fromAttribute(e, r.type), this._$El = null;
    }
  }
  requestUpdate(t, e, s) {
    let i = !0;
    t !== void 0 && (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || nt)(this[t], e) ? (this._$AL.has(t) || this._$AL.set(t, e), s.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, s))) : i = !1), !this.isUpdatePending && i && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
g[D] = !0, g.elementProperties = /* @__PURE__ */ new Map(), g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, K == null || K({ ReactiveElement: g }), ((R = N.reactiveElementVersions) !== null && R !== void 0 ? R : N.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var k;
const T = window, y = T.trustedTypes, F = y ? y.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, I = "$lit$", v = `lit$${(Math.random() + "").slice(9)}$`, rt = "?" + v, pt = `<${rt}>`, A = document, b = () => A.createComment(""), C = (n) => n === null || typeof n != "object" && typeof n != "function", ot = Array.isArray, $t = (n) => ot(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, Q = />/g, _ = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, lt = /^(?:script|style|textarea|title)$/i, vt = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), xt = vt(1), m = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), f = A.createTreeWalker(A, 129, null, !1);
function ht(n, t) {
...
const _t = (n, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const l = n[a];
    let h, d, c = -1, p = 0;
    for (; p < l.length && (r.lastIndex = p, d = r.exec(l), d !== null); ) p = r.lastIndex, r === S ? d[1] === "!--" ? r = G : d[1] !== void 0 ? r = Q : d[2] !== void 0 ? (lt.test(d[2]) && (i = RegExp("</" + d[2], "g")), r = _) : d[3] !== void 0 && (r = _) : r === _ ? d[0] === ">" ? (r = i ?? S, c = -1) : d[1] === void 0 ? c = -2 : (c = r.lastIndex - d[2].length, h = d[1], r = d[3] === void 0 ? _ : d[3] === '"' ? Y : X) : r === Y || r === X ? r = _ : r === G || r === Q ? r = S : (r = _, i = void 0);
    const $ = r === _ && n[a + 1].startsWith("/>") ? " " : "";
    o += r === S ? l + pt : c >= 0 ? (s.push(h), l.slice(0, c) + I + l.slice(c) + v + $) : l + v + (c === -2 ? (s.push(void 0), a) : $);
  }
  return [ht(n, o + (n[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class w {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let o = 0, r = 0;
    const a = t.length - 1, l = this.parts, [h, d] = _t(t, e);
    if (this.el = w.createElement(h, s), f.currentNode = this.el.content, e === 2) {
    ...
    for (; (i = f.nextNode()) !== null && l.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) {
          const c = [];
          for (const p of i.getAttributeNames()) if (p.endsWith(I) || p.startsWith(v)) {
            const $ = d[r++];
            if (c.push(p), $ !== void 0) {
              const at = i.getAttribute($.toLowerCase() + I).split(v), U = /([.?@])?(.*)/.exec($);
              l.push({ type: 1, index: o, name: U[2], strings: at, ctor: U[1] === "." ? At : U[1] === "?" ? yt : U[1] === "@" ? mt : O });
      ...
      } else if (i.nodeType === 8) if (i.data === rt) l.push({ type: 2, index: o });
      else {
        let c = -1;
...
function E(n, t, e = n, s) {
  ...
  return (l == null ? void 0 : l.constructor) !== h && ((o = l == null ? void 0 : l._$AO) === null || o === void 0 || o.call(l, !1), h === void 0 ? l = void 0 : (l = new h(n), l._$AT(n, e, s)), s !== void 0 ? ((r = (a = e)._$Co) !== null && r !== void 0 ? r : a._$Co = [])[s] = l : e._$Cl = l), l !== void 0 && (t = E(n, l._$AS(n, t.values), l, s)), t;
}
class ft {
  constructor(t, e) {
  ...
  u(t) {
    var e;
    const { el: { content: s }, parts: i } = this._$AD, o = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : A).importNode(s, !0);
    f.currentNode = o;
    let r = f.nextNode(), a = 0, l = 0, h = i[0];
    for (; h !== void 0; ) {
      if (a === h.index) {
        let d;
        h.type === 2 ? d = new x(r, r.nextSibling, this, t) : h.type === 1 ? d = new h.ctor(r, h.name, h.strings, this, t) : h.type === 6 && (d = new Et(r, this, t)), this._$AV.push(d), h = i[++l];
      }
...
class x {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), C(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== m && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : $t(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    var e;
    const { values: s, _$litType$: i } = t, o = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = w.createElement(ht(i.h, i.h[0]), this.options)), i);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === o) this._$AH.v(s);
    else {
      const r = new ft(o, this), a = r.u(this.options);
...
class O {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let r = !1;
    if (o === void 0) t = E(this, t, e, 0), r = !C(t) || t !== this._$AH && t !== m, r && (this._$AH = t);
    else {
      const a = t;
      let l, h;
      for (t = o[0], l = 0; l < o.length - 1; l++) h = E(this, a[s + l], e, l), h === m && (h = this._$AH[l]), r || (r = !C(h) || h !== this._$AH[l]), h === u ? t = u : t !== u && (t += (h ?? "") + o[l + 1]), this._$AH[l] = h;
    }
    r && !i && this.j(t);
  }
  j(t) {
...
et == null || et(w, x), ((k = T.litHtmlVersions) !== null && k !== void 0 ? k : T.litHtmlVersions = []).push("2.8.0");
const St = (n, t, e) => {
  var s, i;
